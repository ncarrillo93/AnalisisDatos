...
y_1 = df.iloc[50:150, 4].values
y_1 = np.where(y_1 == 'Iris-versicolor', 1, -1)

y_2 = df.iloc[50:150, 4].values
...
ada1 = AdalineGD(n_iter=100, eta=0.0001).fit(X1, y_1)
ax[0].plot(range(1, len(ada1.cost_) + 1),np.log10(ada1.cost_), marker='o')
ax[0].set_xlabel('Epochs')
ax[0].set_ylabel('log(Sum-squared-error)')
ax[0].set_title('Adaline - Learning rate 0.01')
ada2 = AdalineGD(n_iter=100, eta=0.0001).fit(X1, y_1)
ax[1].plot(range(1, len(ada2.cost_) + 1),ada2.cost_, marker='o')
ax[1].set_xlabel('Epochs')
ax[1].set_ylabel('Sum-squared-error')
ax[1].set_title('Adaline - Learning rate 0.0001')
plt.show()
ada_gd = AdalineGD(n_iter=100, eta=0.0001)
ada_gd.fit(X1_std, y_1)
plot_decision_regions(X1_std, y_1, clasiffier=ada_gd)
